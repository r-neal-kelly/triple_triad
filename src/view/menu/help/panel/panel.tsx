...
export class Panel extends Component<Panel_Props>
{
    ...
    Width():
        Float
    {
        return this.Measurements().Help_Panel_Width();
    }

    Height():
        Float
    {
        return this.Measurements().Help_Panel_Height();
    }

    Padding_Left_Right():
        Float
    {
        return this.Measurements().Help_Panel_Padding_Left_Right();
    }

    Padding_Top_Bottom():
        Float
    {
        return this.Measurements().Help_Panel_Padding_Top_Bottom();
    }
